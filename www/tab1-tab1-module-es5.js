  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
    ...
    function Mzl2(module, __webpack_exports__, __webpack_require__) {
      ...
      var Tab1Page = /*#__PURE__*/function () {
        function Tab1Page(healthKit, plt, userService, navCtrl) {
          var _this = this;
          ...
          this.userService.LoadPage(dataToSend).subscribe(function (response) {
            _this.name = response['name'];
            _this.username = response['username'];
            _this.email = response['email'];
            _this.username = response['username'];
            _this.age = response['age'];
            _this.height = response['height'];
            _this.weight = response['weight'];
            _this.calories_b = response['calories_b'];
            _this.calories_i = response['calories_i'];

            if (response.hasOwnProperty('activity_name')) {
              _this.activity_name = response['activity_name'];
              _this.activity_intensity = response['activity_intensity'];
            }

            if (response.hasOwnProperty('food_name')) {
              _this.food_name = response['food_name'];
            }
        ...
        _createClass(Tab1Page, [{
          ...
          value: function getSteps() {
            ...
            this.healthKit.querySampleType(stepOptions).then(function (data) {
              var stepSum = data.reduce(function (a, b) {
                return a + b.quantity;
              }, 0);
              _this2.stepCount = stepSum;
            }, function (err) {
    ...
    function tmrb(module, __webpack_exports__, __webpack_require__) {
      ...
      Tab1PageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _explore_container_explore_container_module__WEBPACK_IMPORTED_MODULE_6__["ExploreContainerComponentModule"], _tab1_routing_module__WEBPACK_IMPORTED_MODULE_7__["Tab1PageRoutingModule"]],
