(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    /***/
    function jfHL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var UserService = /*#__PURE__*/function () {
        ...
        _createClass(UserService, [{
          key: "Savedata",
          value: function Savedata(dataToSend) {
          ...
          key: "Savelogin",
          value: function Savelogin(dataToSend) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
            headers.append('Content-Type', 'application/json');
            headers.append('Accept', 'application/json');
          ...
          key: "LoadPage",
          value: function LoadPage(dataToSend) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
            headers.append('Content-Type', 'application/json');
            headers.append('Accept', 'application/json');
          ...
          key: "Saveactivity",
          value: function Saveactivity(dataToSend) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
            headers.append('Content-Type', 'application/json');
            headers.append('Accept', 'application/json');
          ...
          key: "Savefood",
          value: function Savefood(dataToSend) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
            headers.append('Content-Type', 'application/json');
            headers.append('Accept', 'application/json');
          ...
          key: "Savelog",
          value: function Savelog(dataToSend) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
            headers.append('Content-Type', 'application/json');
            headers.append('Accept', 'application/json');
          ...
          key: "LoadActivity",
          value: function LoadActivity(dataToSend) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
            headers.append('Content-Type', 'application/json');
            headers.append('Accept', 'application/json');
          ...
          key: "LoadFood",
          value: function LoadFood(dataToSend) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]();
            headers.append('Content-Type', 'application/json');
            headers.append('Accept', 'application/json');
